...
JNIEXPORT int JNICALL
        Java_com_google_sample_echo_MainActivity_fac(JNIEnv *env, jclass, jint);
JNIEXPORT void JNICALL
        Java_com_google_sample_echo_MainActivity_StartClient(JNIEnv * env , jclass) ;
}
...
JNIEXPORT void JNICALL
Java_com_google_sample_echo_MainActivity_StartClient(JNIEnv *env, jclass type) {
